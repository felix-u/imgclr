...
when ODIN_OS == .Windows { foreign import stbi "../../stb_image.lib" }
when ODIN_OS == .Linux   { foreign import stbi "../../stb_image.a"   }
when ODIN_OS == .Darwin  { foreign import stbi "../../stb_image.a"   }
